from PySide6.QtWidgets import QApplication, QMainWindow, QTextEdit, QVBoxLayout, QWidget, QPushButton, QComboBox, QLabel
...
class SnifferThread(QThread):
    ...
    def handle_packet(self, packet):
        with contextlib.redirect_stdout(StringIO()) as f:
            packet.show()
        packet_details = f.getvalue()
        self.new_packet.emit(packet_details)
...
"}")
        ...
        self.setWindowTitle("Islam's Packet Sniffer")
        
        self.text_area = QTextEdit()
        self.text_area.setReadOnly(True)
        
        self.combo_box = QComboBox()
        self.combo_box.addItems(psutil.net_if_addrs().keys())
    ...
    def start_sniffing(self):
        ...
        self.sniffer_thread.new_packet.connect(self.update_text_area)
